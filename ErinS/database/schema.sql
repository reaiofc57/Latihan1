...
INSERT INTO users (nama, email, password, role, foto, bio) VALUES
('Admin Erin', 'admin@techblog.local', '$2y$10$y.sYX/QrrLLECLu7mXf1qusMkRYp.T3J1WWHFsuQ4UN.jwdP5TEAu', 'admin', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop', 'Editor & pendiri TechBlog.'),
('Dewi Kusuma', 'dewi@techblog.local', '$2y$10$y.sYX/QrrLLECLu7mXf1qusMkRYp.T3J1WWHFsuQ4UN.jwdP5TEAu', 'penulis', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop', 'Penulis fokus AI & etika teknologi.'),
('Raka Pratama', 'raka@techblog.local', '$2y$10$y.sYX/QrrLLECLu7mXf1qusMkRYp.T3J1WWHFsuQ4UN.jwdP5TEAu', 'penulis', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop', 'Developer & kontributor programming.'),
('Maya Sari', 'maya@techblog.local', '$2y$10$y.sYX/QrrLLECLu7mXf1qusMkRYp.T3J1WWHFsuQ4UN.jwdP5TEAu', 'penulis', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&h=200&fit=crop', 'Jurnalis gadget & startup.');
...
'<p>UMKM sering menjadi target karena asumsi pertahanan lemah. Langkah pertama: inventaris aset digital, backup rutin, dan autentikasi dua faktor untuk email serta akun cloud.</p>
