...
<section class="section">
    <div class="container" data-aos="zoom-in">
        <div class="newsletter">
            <h2>Newsletter</h2>
            <p>Dapatkan ringkasan artikel terbaru langsung di inbox Anda. Tanpa spam.</p>
            <form class="newsletter-form" id="newsletter-form" action="<?= e(url('api/newsletter.php')) ?>" method="post">
                <input type="email" name="email" required placeholder="email@anda.com" autocomplete="email">
